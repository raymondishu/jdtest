...
function initLeft(){
    //找到父容器
    var parentDom = document.getElementsByClassName("left_category")[0];
    var rightDom = document.getElementsByClassName("right_category")[0];
    //找到子容器
...
function initRight(){
    //右侧
    var parentDom = document.getElementsByClassName("right_category")[0];
    //找到子容器
    var childDom = parentDom.getElementsByClassName('right_category_con')[0];
